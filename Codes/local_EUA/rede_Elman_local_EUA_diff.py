...
def data_import(case_study):
    ...
    '''
    url_train = 'https://github.com/fellypesb/projeto_PET_2021/raw/main/Dados/local_EUA/diff/train_local_EUA.csv'
    url_valid = 'https://github.com/fellypesb/projeto_PET_2021/raw/main/Dados/local_EUA/diff/valid_local_EUA.csv'
    url_test = 'https://github.com/fellypesb/projeto_PET_2021/raw/main/Dados/local_EUA/diff/test_local_EUA.csv'
    ...
    if case_study == 'E2':
        train = pd.read_csv(url_train,
                    usecols=['diff_ghi', 'solar_zenith_angle', 'clearsky_ghi', 'relative_humidity', 'temperature'])
        valid = pd.read_csv(url_valid,
                    usecols=['diff_ghi', 'solar_zenith_angle', 'clearsky_ghi', 'relative_humidity', 'temperature'])
    ...
    if case_study == 'E3':
        train = pd.read_csv(url_train,
                    usecols=['seasons', 'diff_ghi', 'solar_zenith_angle', 'clearsky_ghi', 'relative_humidity', 'temperature'])
        valid = pd.read_csv(url_valid,
                    usecols=['seasons', 'diff_ghi', 'solar_zenith_angle', 'clearsky_ghi', 'relative_humidity', 'temperature'])
    ...
    if case_study == 'E4':
        train = pd.read_csv(url_train,
                    usecols=['diff_ghi', 'relative_humidity', 'temperature'])
        valid = pd.read_csv(url_valid,
                    usecols=['diff_ghi', 'relative_humidity', 'temperature'])
...
X_train = train.drop(['diff_ghi'], axis=1)
y_train = train['diff_ghi']
X_valid = valid.drop(['diff_ghi'], axis=1)
y_valid = valid['diff_ghi']

X_test = test.drop(['diff_ghi'], axis=1)
y_test = test['diff_ghi']
...
DELAY = 5  # valores de delay -> [3, 5, 8, 13]
